...
- When creating or updating `.env.example`, omit any variable whose value is personal information (e.g. `EMAIL_ADDRESS`, `WALLET_ADDRESS`) entirely — do not include it with a placeholder, and never copy real values from `.env`.
